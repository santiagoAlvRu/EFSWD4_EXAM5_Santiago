...
if (mysqli_num_rows($result) > 0) {
    foreach ($rows as $row) {
        $layout .= "<div class='col mb-4 d-flex justify-content-center'>
    <div class='card h-100 shadow-lg border-0 rounded-4' style='max-width: 20rem;'>
        ...
        <div class='card-body text-center p-4'>
            ...
            <p class='card-text mb-3'><strong>Age:</strong> $row[age] years</p>
    ...
    $layout = "<p class='text-danger'>No results found</p>";
}
?>
...
<body>
    ...
    <h2 class="text-center mt-3">Our Seniors</h2>
